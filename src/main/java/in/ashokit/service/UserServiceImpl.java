...
import in.ashokit.repo.CityEntityRepo;
import in.ashokit.repo.CountryEntityRepo;
import in.ashokit.repo.StateEntityRepo;
import in.ashokit.repo.UserEntityRepo;

@Service
public class UserServiceImpl implements UserService{
	
	@Autowired
	private CountryEntityRepo countryRepo;
	
	@Autowired
	private StateEntityRepo stateRepo;
	
	@Autowired
	private CityEntityRepo cityRepo;
